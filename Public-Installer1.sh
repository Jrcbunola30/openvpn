...
export RepoURL='yakult13/installer/main'
...
xInstall(){
 ...
 wget -qO - http://build.openvpn.net/debian/openvpn/stable/pubkey.gpg|apt-key add -
    ...
    mkdir -p /etc/ins
    cd /etc/ins
    curl -skLO -H "Authorization: token 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" -H "Accept: application/vnd.github.v3.raw" "https://raw.githubusercontent.com/${RepoURL}/SSH"
    curl -skLO -H "Authorization: token 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" -H "Accept: application/vnd.github.v3.raw" "https://raw.githubusercontent.com/${RepoURL}/Dropbear"
    curl -skLO -H "Authorization: token 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" -H "Accept: application/vnd.github.v3.raw" "https://raw.githubusercontent.com/${RepoURL}/Squid"
    curl -skLO -H "Authorization: token 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" -H "Accept: application/vnd.github.v3.raw" "https://raw.githubusercontent.com/${RepoURL}/Stunnel"
    curl -skLO -H "Authorization: token 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" -H "Accept: application/vnd.github.v3.raw" "https://raw.githubusercontent.com/${RepoURL}/OpenVPN"
    curl -skLO -H "Authorization: token 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" -H "Accept: application/vnd.github.v3.raw" "https://raw.githubusercontent.com/${RepoURL}/Configs"
    curl -skLO -H "Authorization: token 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" -H "Accept: application/vnd.github.v3.raw" "https://raw.githubusercontent.com/${RepoURL}/Firewall"
    curl -skLO -H "Authorization: token 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" -H "Accept: application/vnd.github.v3.raw" "https://raw.githubusercontent.com/${RepoURL}/Menu"
    curl -skLO -H "Authorization: token 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" -H "Accept: application/vnd.github.v3.raw" "https://raw.githubusercontent.com/${RepoURL}/Websocket"
    curl -skLO -H "Authorization: token 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" -H "Accept: application/vnd.github.v3.raw" "https://raw.githubusercontent.com/${RepoURL}/OHP"
    curl -skLO -H "Authorization: token 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" -H "Accept: application/vnd.github.v3.raw" "https://raw.githubusercontent.com/${RepoURL}/Nginx"
    curl -skLO -H "Authorization: token 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" -H "Accept: application/vnd.github.v3.raw" "https://raw.githubusercontent.com/${RepoURL}/CreateDNS"
    chmod +x *
